...
<div id="myModal" class="modal fade w-100" role="dialog" action="">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <input class="w-100 form-control m-1" id="input_nome" name="produto_nome" type="text"
        placeholder="Digite o nome do produto">
      <p class=" m-1" style="color: rgb(4, 39, 105)">FABRICANTE</p>
      <select class=" m-1  custom-select fab_select" for="produto_fabricante" name="produto_fabricante">
...
?>
      ...
      <a class="modal_update_link">
        <button class="btn mt-2" id="update_btn" style="background-color: rgb(4, 39, 105); color:white"
          name="produto_update" type="submit">Atualizar</button>
      </a>
      <!-- </form> -->
    </div>
  </div>
