...
<div class="container  d-flex justify-content-between">
    <div class="bg-white w-50 m-3">
        ...
        <form method="post">
            ...
            <input class="w-100 form-control" name="fabricante_nome" type="text" placeholder="Digite o nome do fabricante">
            ...
            <button class="btn mt-2" style="background-color: rgb(4, 39, 105); color:white" name="fabricante_add" type="submit">Adicionar</button>
        </form>
    ...
    <div class=" w-50 m-3">
        ...
        <form method="post">
            ...
            <input class="w-100 form-control m-1" name="produto_nome" type="text" placeholder="Digite o nome do produto">
            ...
            <button class="btn mt-2" style="background-color: rgb(4, 39, 105); color:white" name="produto_add" type="submit">Adicionar</button>
        </form>
    ...
    <table id="content_Table" class="table table-striped table-hover table-sm" style="width:100%">
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    <td style="color: rgb(4, 39, 105)"><?php echo $id; ?></td>
                    <td><?php echo $nome; ?></td>
                    <td><?php echo $nome_fabricante; ?></td>
                    <td><?php echo $categoria; ?></td>
                    <td><?php echo $preco; ?></td>
                    <td><button class="btn edit_button" rel="<?php echo $id; ?>" style="background-color: rgb(4, 39, 105); 
                    color:white">Editar
                            Equipes</button>
                    </td>
                    <td>
                        <a href="index.php?delete=<?php echo $id; ?> ">
                            <button class="btn" style="background-color: rgb(4, 39, 105); color:white">delete</button>
                        </a>
                    </td>
                </tr>
            <?php
